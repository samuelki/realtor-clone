...
export default function Listing() {
  ...
  return (
    <main>
      ...
      {shareLinkCopied && (
        <p className='fixed top-[17%] right-[5%] font-semibold border-2 border-gray-400 rounded-md bg-white z-10 p-2'>
          Link Copied
        </p>
      )}
      ...
      <div className='m-4 p-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto rounded-lg shadow-lg bg-white lg:space-x-5'>
        <div className='w-full'>
          ...
          <p className='mt-3 mb-3'>{listing.description}</p>
          ...
          {listing.userRef !== auth.currentUser?.uid && !contactLandlord && (
            <div className='mt-6'>
              <button
                ...
                className='px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg transition ease-in-out duration-150 focus:bg-blue-700 focus:shadow-lg w-full text-center'
              >
                Contact Landlord
              </button>
            </div>
